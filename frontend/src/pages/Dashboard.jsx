                  ...
                  <div className="card-body p-4">
                    <div className="d-flex align-items-center mb-3">
                      <div className="bg-warning bg-opacity-10 rounded-circle p-2 me-3">
                        <i className="bi bi-person-plus-fill text-warning fs-4"></i>
                      </div>
                      <h5 className="card-title mb-0 fw-bold">Postulantes</h5>
                    </div>
                    <p className="card-text text-muted mb-4">
                      Registrese como postulante.
                    </p>
                    <Link to="/postulant" className="btn btn-warning w-100 text-white">
                      <i className="bi bi-arrow-right-circle me-2"></i>
                      Registrarse
                    </Link>
                  </div>
                        ...
                        <span className={`badge fs-6 px-3 py-2 ${user?.role === 'admin' ? 'bg-dark bg-opacity-75' :
                          ...
                          {user?.role === 'gestion_vehicular' ? 'Gestión Vehicular' :
                            user?.role === 'gestion_peatonal' ? 'Gestión Peatonal' :
                              user?.role === 'postulante' ? 'Postulante' :
                                user?.role}
                        </span>
                      </div>
                    </div>
