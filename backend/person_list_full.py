...
PATH_PERSON_LIST = "/artemis/api/resource/v1/person/personList"
...
OUTPUT_FILE = "personas_full.json"
...
def main():
    ...
    while True:
        ...
        j = post_signed(PATH_PERSON_LIST, body)
        ...
        # Guardamos TODA la info que viene de la API
        for p in lst:
            personas.append(p)
